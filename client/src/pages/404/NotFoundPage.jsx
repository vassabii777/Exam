...
const useMouseParallax = (...depths) => {
    ...
    useDocumentEvent('mousemove', e => {
        requestAnimationFrame(() => {
            ...
            const x = e.clientX / width - 0.5, y = e.clientY / height - 0.5;
...
const Canyon = () => {
    ...
    return (
        <svg viewBox='0 0 2000 720' className='background-gray' preserveAspectRatio='xMidYMid slice'>
            <path style={{ transform: `translate(${p3.x}px,${p3.y}px)` }} strokeWidth={5} d="M1831 198L1823 763L1728 766V189ZM1390 147V780H1133V158ZM793 183V780H591.3V184ZM546 203V734.7H493V200ZM357 183V758.1H203.6V183ZM12 180V754.7H-147.4V188Z" />
            <path style={{ transform: `translate(${p3.x}px,${p3.y}px)` }} className='fill-gray-900' d="M-203.5 227V-240.6H2229.6V92.4L1830 21.4L1728 50.4L1393 35.6L1135 115.6L1050 85.6L848 117.6L803 82.6L753 101.6L669 66.6L515 117.6L320.6 59.6L160 117.6Z" />
            ...
            <path style={{ transform: `translate(${p5.x}px,${p5.y}px)` }} d="M2195 396V927.1H-242.2V389L117 449L213 427L276 471L445 431L528 470L876 423L1023 451L1148 419L1223 466L1298 445L1519 473L1782 398L1891 429Z" />
...
const NotFoundPage = () => (
    <div className='app'>
        <div className='text-container'>
            ...
            <p>You can <a href="/">go back home</a>, or <a href="/search">search for something</a>.</p>
        </div>
        <Canyon />
    </div>
);
